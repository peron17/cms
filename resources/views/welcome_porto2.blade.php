...
<html class="fixed">
	<head>
		...
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/bootstrap/css/bootstrap.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/animate/animate.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/font-awesome/css/all.min.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/magnific-popup/magnific-popup.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/jquery-ui/jquery-ui.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/jquery-ui/jquery-ui.theme.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/bootstrap-multiselect/css/bootstrap-multiselect.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/vendor/morris/morris.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/css/theme.css') }}"/>
		<link rel="stylesheet" href="{{ asset('porto_new/css/custom.css') }}"/>

		<script src="{{ asset('porto_new/vendor/modernizr/modernizr.js') }}"></script>
		<script src="{{ asset('porto_new/master/style-switcher/style.switcher.localstorage.js') }}"></script>
	</head>
	<body>
		<section class="body">
			<header class="header">
				<div class="logo-container">
					<a href="" class="logo">						
                        <img src="{{ asset('porto_new/img/logo.png') }}" width="75" height="35" alt="Porto Admin">
                    </a>					
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ asset('porto_new/img/!sample-user.jpg') }}" alt="Joseph Doe Junior" class="rounded-circle">
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ asset('porto_new/img/!sample-user.jpg') }}" alt="Joseph Junior" class="rounded-circle">
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ asset('porto_new/img/!sample-user.jpg') }}" alt="Joe Junior" class="rounded-circle">
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{ asset('porto_new/img/!logged-user.jpg') }}" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/!logged-user.jpg">
							</figure>
							...
							<div class="sidebar-widget widget-tasks">
								...
								<div class="widget-content">
									<ul class="list-unstyled m-0">
										<li>
											<a href="#">Porto HTML5 Template</a>
										</li>
										<li>
											<a href="#">Tucson Template</a>
										</li>
										<li>
											<a href="#">Porto Admin</a>
										</li>
									</ul>
								</div>
							</div>
												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Porto Admin" selected>
																Porto Admin
															</option>
															<option value="Porto Drupal">
																Porto Drupal
															</option>
															<option value="Porto Wordpress">
																Porto Wordpress
															</option>
														</select>
													</strong>
							...
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">
										Customize the graphs as much as you
										                                        want, there are so many options and
										                                        features to display information using
						...
						<div class="col-lg-6">
							<section class="card">
								<header class="card-header">
									...
									<p class="card-subtitle">
										It's easy to create custom graphs on
										                                        Porto Admin Template, there are several
										                                        graph types that you can use.
									</p>
								</header>
								<div class="card-body">
										...
										<header class="card-header bg-primary w-100">
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="{{ asset('porto_new/img/!logged-user.jpg') }}"/>
												</div>
														...
														<ul class="widget-todo-list">
															...
															<li>
																<div class="checkbox-custom checkbox-default">
																	...
																	<label class="todo-label" for="todoListItem2">
																		<span>Lorem
																			                                                                            ipsum
																			                                                                            dolor
																			                                                                            sit
															...
															<li>
																<div class="checkbox-custom checkbox-default">
																	...
																	<label class="todo-label" for="todoListItem3">
																		<span>Curabitur
																			                                                                            ac
																			                                                                            sem
																			                                                                            at
															...
															<li>
																<div class="checkbox-custom checkbox-default">
																	...
																	<label class="todo-label" for="todoListItem4">
																		<span>Lorem
																			                                                                            ipsum
																			                                                                            dolor
																			                                                                            sit
															...
															<li>
																<div class="checkbox-custom checkbox-default">
																	...
																	<label class="todo-label" for="todoListItem5">
																		<span>Curabitur
																			                                                                            ac
																			                                                                            sem
																			                                                                            at
															...
															<li>
																<div class="checkbox-custom checkbox-default">
																	...
																	<label class="todo-label" for="todoListItem6">
																		<span>Lorem
																			                                                                            ipsum
																			                                                                            dolor
																			                                                                            sit
															...
															<li>
																<div class="checkbox-custom checkbox-default">
																	...
																	<label class="todo-label" for="todoListItem7">
																		<span>Curabitur
																			                                                                            ac
																			                                                                            sem
																			                                                                            at
													...
													<div class="card-body">
														<ul class="simple-user-list mb-3">
															<li>
																...
																<span class="title">Joseph Doe
																	                                                                    Junior</span>
																<span class="message">Lorem ipsum
																	                                                                    dolor
																	                                                                    sit.</span>
															</li>
															<li>
...
4,
											...
											<p class="text-3 text-muted mb-0">
										...
										<div class="card-body">
											<div class="circular-bar circular-bar-xs m-0 mt-1 mr-4 mb-0 float-right">
												<div class="circular-bar-chart" data-percent="45" data-plugin-options='{ "barColor": "#2baab1", "delay": 300, "size": 50, "lineWidth": 4 }'>
													...
													<label>
														<span class="percent">45</span>%</label>
												</div>
											</div>
											<div class="h4 font-weight-bold mb-0">
												12
									...
									<div class="content">
										<ul class="simple-user-list">
											<li>
												...
												<span class="message truncate">Lorem ipsum dolor
													                                                    sit.</span>
											</li>
											<li>
												<figure class="image rounded">
													...
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-fluid" width="215" src="{{ asset('porto_new/img/projects/project-4.jpg') }}"/>
																<span class="zoom">
																	<i class="bx bx-search"></i>
																</span>
															</a>
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="{{ asset('porto_new/img/!sample-user.jpg') }}" alt="Joseph Doe" class="rounded-circle"/>
										</figure>
										<div class="profile-info">
